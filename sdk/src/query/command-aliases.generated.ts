...
export const NON_FAMILY_COMMAND_ALIASES: readonly NonFamilyCommandAlias[] = [
  ...
  { canonical: 'phase.uncomplete', aliases: ['phase uncomplete'], mutation: true },
  ...
  { canonical: 'requirements.mark-incomplete', aliases: ['requirements mark-incomplete'], mutation: true },
